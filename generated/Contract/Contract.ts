...
export class Contract__getExpectedTargetResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract extends ethereum.SmartContract {
  ...
  getExpectedTarget(): Contract__getExpectedTargetResult {
    let result = super.call(
      "getExpectedTarget",
    ...
    return new Contract__getExpectedTargetResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_getExpectedTarget(): ethereum.CallResult<
    Contract__getExpectedTargetResult
  > {
    let result = super.tryCall(
      "getExpectedTarget",
      "getExpectedTarget():(uint256,uint256)",
    ...
    return ethereum.CallResult.fromValue(
      new Contract__getExpectedTargetResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
